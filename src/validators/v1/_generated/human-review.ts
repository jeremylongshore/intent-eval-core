...
export default z
  .object({
    id: z
      .any()
      .describe('UUIDv7 PK. The `human_review_id` the human-review/v1 predicate body references.'),
    eval_run_id: z
      .any()
      .describe('FK -> EvalRun.id (required). The EvalRun this human is assessing.'),
    session_trace_id: z
      .any()
      .superRefine((x, ctx) => {
