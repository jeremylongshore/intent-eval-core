...
describe('plugin-manifest v2 — ajv ↔ Zod fold agreement on composition branches', () => {
  it.each([
    ...
    ['non-string repository rejected', { repository: 7 }, false],
    ['non-uri repository rejected', { repository: 'not-a-uri' }, false],
    ...
    ['skills as a number rejected', { skills: 7 }, false],
    ['lspServers as a number rejected', { lspServers: 7 }, false],
    ['outputStyles as a number rejected', { outputStyles: 7 }, false],
