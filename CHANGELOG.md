...
- **Six audit-deferred kernel specs LOCKED additively** (`lineage: blueprint-b@7.4`; deferrals bd `bd_000-projects-{gzgj,ra9a,21re,9xyk,84li,k0fj}`). The shapes Blueprint B (intent-eval-lab `012-AT-ARCH-platform-runtime-blueprint.md`) named-but-deferred are now locked. Every lockup is **additive + backward-compatible** per Blueprint B § 7.2 — existing v1 rows/fixtures stay valid, no predicate-URI bump:
